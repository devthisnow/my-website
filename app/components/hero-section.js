...
export default function HeroSection(props) {
    return (
        <section className="flex flex-row justify-center w-full min-h-[890px] max-h-[890px] bg-mygray pl-[80px]">
            <div className="flex flex-col justify-between w-1/2 grow h-auto overflow-hidden">
                ...
                <button className="px-4 py-2 mb-[50px] ml-[3px] rounded-full outline outline-3 w-[77px] h-[77px] hover:bg-transparent hover:outline-black focus:outline-black animate-bounce ">
