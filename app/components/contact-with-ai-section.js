...
export default function ContactWithAI(props) {
    return (
        <section className="w-full sm:min-h-[890px] px-[30px] sm:pl-[80px] mt-[65px] sm:mt-[170px] mb-[80px] sm:mb-[40px] ">
            <div className="flex flex-col sm:flex-row justify-between sm:flex-wrap ">
                <div className="basis-1/2 min-w-[340px] shrink sm:grid grid-cols-6 grid-rows-1 sm:gap-x-[20px] mt-0 sm:mt-[130px]">
